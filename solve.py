...
def try_to_prove_htw_geq_2():
    for v in range(1, num_vertices + 1):
        he_with_v = [he for he in hyperedges.values() if v in he.vertex_set]
        he_without_v = [he for he in hyperedges.values() if v not in he.vertex_set]
        for he1 in he_with_v:
            for he2 in he_with_v:
                if he1 != he2:
                    vv_in_he1_but_not_he2 = he1.vertex_set - he2.vertex_set
                    vv_in_he2_but_not_he1 = he2.vertex_set - he1.vertex_set
                    if len(vv_in_he1_but_not_he2) and len(vv_in_he2_but_not_he1):
                        for he3 in he_without_v:
                            if len(he3.vertex_set & vv_in_he1_but_not_he2) and len(he3.vertex_set & vv_in_he2_but_not_he1):
                                return True
    return False

proved_htw_geq_2 = try_to_prove_htw_geq_2()
...
#    print "c score ", score
    ...
    if sigterm_received:
        break
    if best_score == 2 and proved_htw_geq_2:
        break
...
if best_score > 2 or (best_score == 2 and not proved_htw_geq_2):
    exit(1)
